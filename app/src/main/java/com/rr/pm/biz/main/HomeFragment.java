...
import com.rr.pm.biz.CaptureActivity;
import com.rr.pm.biz.LiveWall.ViewLiveWallpaper;
import com.rr.pm.biz.TestClockActivity;
import com.rr.pm.biz.TestIconActivity;
...
public class HomeFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_builder).setOnClickListener(this);
        view.findViewById(R.id.btn_observer).setOnClickListener(this);
        view.findViewById(R.id.btn_clone).setOnClickListener(this);
        view.findViewById(R.id.btn_policy).setOnClickListener(this);
        view.findViewById(R.id.btn_dynamic_proxy).setOnClickListener(this);
        view.findViewById(R.id.btn_icon).setOnClickListener(this);
        view.findViewById(R.id.btn_clock).setOnClickListener(this);
        view.findViewById(R.id.btn_load_patch).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_request) {
            ...
            ToastUtils.show(getActivity(), "我是测试load patch");
    ...
    private void testWallpaper() {
        ViewLiveWallpaper.setToWallpaper(getActivity());
    }


    private void textLoadPatch() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int flag = ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE);
    ...
    private void loadPatch() {
        ...
        if (file.isFile() && file.exists()) {
            TinkerInstaller.onReceiveUpgradePatch(getActivity().getApplicationContext(), filePath);
        } else {
            ToastUtils.show(getActivity(), "补丁文件不存在!");
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == PRE_REQ_CODE) {
            if (grantResults != null && grantResults.length > 0) {
                ...
                ToastUtils.show(getActivity(), "获取读取存储权限失败!");
            }
        }
    }

    private void testIconMarker() {
        startActivity(new Intent(getActivity(), TestIconActivity.class));
    }
    ...
    private void dynamic_proxy() {
        ...
        ToastUtils.show(getActivity(), "sum=" + sum);
    }
    ...
    public void testClock() {
        startActivity(new Intent(getActivity(), TestClockActivity.class));
    }
}
